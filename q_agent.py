...
class QAgent(Agent):
    ...
    def update_action_policy(self) -> None:
        ...
        # Z LABKI:
        # W strategii ε-zachłannej takie zachowanie można osiągnąć stosując malejące ε,
        # np. odejmując pewną małą wartość εdecrement, aż do osiągnięcia pewnego minimum eksploracji εmin.
